    ...
    return (
        <MainDiv>
            ...
            <Basic>
                <LeftNavi model="b" />
                <TaskList>
                    <Tytul>Układy równań liniowych</Tytul>
                    <MainGuz data-poddzialy>
                        <Guz id="1" onClick={renderTask}>Rozwiązywanie układów równań metodą podstawiania</Guz>
                        <Guz id="2" onClick={renderTask}>Rozwiązywanie układów równań metodą przeciwnych współczynników</Guz>
                        <Guz id="3" onClick={renderTask}>Rozwiązywanie układów równań metodą graficzną</Guz>
                       
                    </MainGuz>

                    <TaskList>
                        <Rodzajzad>{title}</Rodzajzad>
                        <WorksList model={currentTask} dzial="5" />
                    </TaskList>
                </TaskList>
