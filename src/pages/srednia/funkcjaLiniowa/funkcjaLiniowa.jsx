    ...
    return (
        <MainDiv>
            ...
            <Basic>
                <LeftNavi model="b" />
                <TaskList>
                    <Tytul>Funkcja liniowa</Tytul>
                    <MainGuz data-poddzialy>
                        <Guz id="1" onClick={renderTask}>Proporcjonalność prosta</Guz>
                        <Guz id="2" onClick={renderTask}>Wykres i miejsce zerowe funkcji liniowej</Guz>
                        <Guz id="3" onClick={renderTask}>Współczynnik kierunkowy</Guz>
                        <Guz id="4" onClick={renderTask}>Własności funkcji liniowej</Guz>
                       
                    </MainGuz>

                    <TaskList>
                        <Rodzajzad>{title}</Rodzajzad>
                        <WorksList model={currentTask} dzial="4" />
                    </TaskList>
                </TaskList>
