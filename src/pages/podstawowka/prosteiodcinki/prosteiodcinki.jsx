    ...
    return (
        <MainDiv>
            ...
            <Basic>
                <LeftNavi model="a" />
                <TaskList>
                    <Tytul>Proste i odcinki</Tytul>
                    <MainGuz data-poddzialy>
                        <Guz id="1" onClick={renderTask}>Podstawowe figury płaskie</Guz>
                        <Guz id="2" onClick={renderTask}>Powiększanie i zmniejszanie odcinka</Guz>
                        <Guz id="3" onClick={renderTask}>Skala i plan</Guz>
                        <Guz id="4" onClick={renderTask}>Wzajemne położenie prostych i odcinków</Guz>
                    ...
                    <TaskList>
                        ...
                        <WorksList model={currentTask} dzial="sp7" />
                    </TaskList>
                </TaskList>
