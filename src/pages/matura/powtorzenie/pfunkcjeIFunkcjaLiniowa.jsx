        ...
        <div className={mainDiv}>
            ...
            <div className={basic} >
                ...
                <div className={tasksList}>
                    <h2 className={tytul}>Powtórki maturalne - Funkcja. Funkcja liniowa</h2>
                    ...
                    <div className={tasks}>
                        ...
                        <WorksList model={currentTask} dzial="cp2" />
                    </div>
...
export default PFunkcjeIFunkcjaLiniowa